...
The early 2.x UI used a small hard-coded pixel-art switch. F3+ now uses the larger
recolorable SVG library in ``vector_icons`` while keeping ``icon_pixmap`` stable for
existing callers. Installed Minecraft textures are still attempted by callers first.
"""
